...
//       db.collection('bodyfocus').find().toArray((err, result) => {
...
//     app.put('/catalog/status', (req, res) => {
...
//     app.put('/catalog/condition', (req, res) => {
//       db.collection('catalog')
//       .findOneAndUpdate({_id: new ObjectID(req.body.id)}, {
//         $set: {
...
//       db.collection('catalog').findOneAndDelete({_id: new ObjectID(req.body.id)}, (err, result) => {
...
//             failureFlash : true // allow flash catalog
//         }));
